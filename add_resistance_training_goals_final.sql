...
-- 2. Add resistance_training_days column to health_data table (for weekly actual data)
ALTER TABLE health_data ADD COLUMN resistance_training_days INTEGER;
ALTER TABLE health_data ADD CONSTRAINT check_resistance_days CHECK (resistance_training_days >= 0 AND resistance_training_days <= 7);
