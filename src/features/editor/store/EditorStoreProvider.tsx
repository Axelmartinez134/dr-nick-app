...
const noopActions: EditorActions = {
  ...
  onClickOpenShareCarouselsLink: async () => {},
  ...
  onChangeProjectReviewDriveFolderUrl: async () => {},
  setShowDebugPreview: () => {},
...
const defaultState: EditorState = {
  ...
  swipeFileModalOpen: false,
  htmlTemplatesBrowseModalOpen: false,
  scriptChatModalOpen: false,
  scriptChatProjectId: null,
  brandAlignmentModalOpen: false,
  shareCarouselsModalOpen: false,
  slideStyleModalOpen: false,
  bodyRegenModalOpen: false,
  bodyRegenTargetProjectId: null,
  bodyRegenTargetSlideIndex: null,
  bodyRegenOriginalByKey: {},
