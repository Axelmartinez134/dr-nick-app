import { IMPORTED_MIRR_TECH_PRESETS } from "./importedMirrTechPresets";

export type HtmlPresetPageType = "cover" | "content" | "cta";
...
export type HtmlPresetTemplate = {
  id: string;
  name: string;
  pageType?: HtmlPresetPageType | null;
  html: string;
};
