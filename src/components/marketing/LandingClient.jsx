  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-4">
        ...
        <button type="button" className="magnetic-btn bg-electric-coral text-void px-5 py-2.5 rounded-full font-inter font-medium text-sm">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-12 flex flex-col lg:flex-row justify-between items-center gap-12">
        ...
        <div ref={textRef} className="max-w-3xl flex flex-col items-start w-full lg:w-2/3">
          ...
          <div className="hero-text-el flex items-center gap-6">
            <button type="button" className="magnetic-btn bg-electric-coral hover:bg-electric-coral/90 text-void px-8 py-4 rounded-full font-inter font-semibold text-[15px] flex items-center gap-2">
              <span>Join the Beta</span>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center max-w-6xl mx-auto">
          ...
          <div className="pricing-card bg-white rounded-[2rem] p-10 shadow-sm border border-black/5 flex flex-col h-full">
            ...
            <button type="button" className="w-full py-4 mt-8 rounded-full border-2 border-charcoal text-charcoal font-inter font-bold hover:bg-charcoal hover:text-white transition-colors duration-300">
              Join the Beta
            </button>
          </div>
          ...
          <div className="pricing-card bg-void rounded-[2.5rem] p-10 shadow-2xl relative md:scale-105 z-10 flex flex-col h-full">
            ...
            <button type="button" className="magnetic-btn w-full py-4 mt-8 rounded-full bg-electric-coral text-void font-inter font-bold text-lg hover:bg-electric-coral/90 transition-colors shadow-[0_0_30px_rgba(255,77,0,0.3)] hover:shadow-[0_0_40px_rgba(255,77,0,0.5)]">
              <span>Join the Beta</span>
            </button>
          </div>
          ...
          <div className="pricing-card bg-white rounded-[2rem] p-10 shadow-sm border border-ultraviolet/20 flex flex-col h-full relative">
            ...
            <button type="button" className="magnetic-btn w-full py-4 mt-8 rounded-full bg-ultraviolet text-white font-inter font-bold hover:bg-ultraviolet/90 transition-colors">
    ...
    <section ref={sectionRef} className="w-full bg-void py-40 px-6 relative overflow-hidden flex flex-col items-center">
      ...
      <div ref={cardRef} className="w-full max-w-xl bg-white rounded-[2.5rem] p-8 md:p-12 shadow-2xl relative z-10 mx-4">
        <form className="flex flex-col gap-6" onSubmit={e => e.preventDefault()}>
          ...
          <button type="button" className="form-el submit-btn magnetic-btn w-full py-5 rounded-full bg-electric-coral text-void font-inter font-bold text-lg hover:bg-electric-coral/90 transition-colors mt-2 flex items-center justify-center gap-2">
