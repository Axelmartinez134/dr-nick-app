...
{
  "slides": [
    { "index": 0, "ranges": [ { "start": 0, "end": 10, "bold": true } ] }
  ]
}
...
export async function POST(request: NextRequest) {
  ...
  let body: Body & { guidanceText?: string | null };
  try {
  ...
  try {
    ...
    return NextResponse.json({ success: true, rangesBySlide: out.rangesBySlide, debug: { model: out.model } });
  } catch (e: any) {
